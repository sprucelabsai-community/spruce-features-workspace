...
export declare namespace SpruceErrors.Store {
    ...
    export type FailedToLoadStoreEntity =
        SchemaEntity<SpruceErrors.Store.FailedToLoadStoreSchema>
}
...
export declare namespace SpruceErrors.Store {
    ...
    export type FailedToLoadDbAdapterEntity =
        SchemaEntity<SpruceErrors.Store.FailedToLoadDbAdapterSchema>
}
