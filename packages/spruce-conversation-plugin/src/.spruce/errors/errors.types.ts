...
export declare namespace SpruceErrors.Conversation {
    ...
    export type TopicNotFoundEntity =
        SchemaEntity<SpruceErrors.Conversation.TopicNotFoundSchema>
}
...
export declare namespace SpruceErrors.Conversation {
    ...
    export type TesterNotStartedEntity =
        SchemaEntity<SpruceErrors.Conversation.TesterNotStartedSchema>
}
...
export declare namespace SpruceErrors.Conversation {
    ...
    export type MissingDependenciesEntity =
        SchemaEntity<SpruceErrors.Conversation.MissingDependenciesSchema>
}
...
export declare namespace SpruceErrors.Conversation {
    ...
    export type InvalidTopicEntity =
        SchemaEntity<SpruceErrors.Conversation.InvalidTopicSchema>
}
...
export declare namespace SpruceErrors.Conversation {
    ...
    export type ConversationPluginErrorEntity =
        SchemaEntity<SpruceErrors.Conversation.ConversationPluginErrorSchema>
}
...
export declare namespace SpruceErrors.Conversation {
    ...
    export type ConversationAbortedEntity =
        SchemaEntity<SpruceErrors.Conversation.ConversationAbortedSchema>
}
...
export declare namespace SpruceErrors.Conversation {
    ...
    export type AbortEntity =
        SchemaEntity<SpruceErrors.Conversation.AbortSchema>
}
